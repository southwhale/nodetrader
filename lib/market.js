...
(function() {
	this._init = function() {
		...
		this.ctp.createMdApi(this.accountID);
	...
	this.OnFrontConnected = function() {
	  logger.info('Market->ReqUserLogin : %s', this.ctp.md.ReqUserLogin(this.ctp.getAccountByUserID(this.accountID), this.ctp.nRequestID()));
