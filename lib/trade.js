...
(function() {
	this._init = function(topicMode) {
		...
		this.ctp.createTdApi(this.accountID);
	...
	this.OnFrontConnected = function() {
		logger.info('Trade->ReqUserLogin : %s', this.ctp.td.ReqUserLogin(this.ctp.getAccountByUserID(this.accountID), this.ctp.nRequestID()));
